...
green = gr.material({0, 1, 0}, {0, 0, 0}, 25, 0, 0, 0)
white = gr.material({1, 1, 1}, {0, 0, 0}, 25, 0, 0, 0)
red = gr.material({1, 0, 0}, {0, 0, 0}, 25, 0, 0, 0)
black = gr.material({0, 0, 0}, {0, 0, 0}, 25, 0, 0, 0)
blue = gr.material({0, 0, 1}, {0, 0, 0}, 25, 0, 0, 0)
...
gr.render(scene_root, 'mirror_reflection.png', 500, 500,
